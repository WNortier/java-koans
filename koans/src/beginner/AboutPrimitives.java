...
public class AboutPrimitives {
    ...
    public void primitivesOfTypeIntHaveAnObjectTypeInteger() {
        Object number = 1;
        assertEquals(getType(number).toString(), "class java.lang.Integer");
    ...
    public void primitivesOfTypeLongHaveAnObjectTypeLong() {
        Object number = 1L;
        assertEquals(getType(number).toString(), "class java.lang.Long");
    }
    ...
    public void primitivesOfTypeShortHaveAnObjectTypeShort() {
        ...
        assertEquals(getType(number).toString(), "class java.lang.Short");
    }
    ...
    public void primitivesOfTypeByteHaveAnObjectTypeByte() {
        ...
        assertEquals(getType(number).toString(), "class java.lang.Byte");
    }
    ...
    public void primitivesOfTypeCharHaveAnObjectTypeCharacter() {
        ...
        assertEquals(getType(number).toString(), "class java.lang.Character");
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        assertEquals(1E3, 1000.0d);
    }

    @Koan
    public void primitivesOfTypeDoubleHaveAnObjectTypeDouble() {
        Object number = 1.0;
        assertEquals(getType(number).toString(), "class java.lang.Double");
    }
    ...
    public void primitivesOfTypeFloatHaveAnObjectTypeFloat() {
        Object number = 1f;
        assertEquals(getType(number).toString(), "class java.lang.Float");
    }
